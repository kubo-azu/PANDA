...
jsonlite::write_json(
  list(
    ...
    overall_test_exact = comparison$overall_test_exact,
    overall_test_statistic = comparison$overall_test_statistic,
    overall_test_r_method = comparison$overall_test_r_method,
